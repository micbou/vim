...
set vim_description=Vim %vim_version% 32-bit and 64-bit for Windows with Lua %lua_version%, Perl %perl_version%, Python %python2_version%, Python %python3_version%, and Ruby %ruby_version% support. Compiled with MSVC %msvc%.
